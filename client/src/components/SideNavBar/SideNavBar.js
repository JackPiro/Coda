...
const SideNavBar = () => {
    ...
    return (
        ...
        <div className="fixed flex flex-col w-48 h-screen px-6 py-4 text-blue-100 bg-[#181C25]">
            ...
            <div className="hover:bg-gray-500 -mx-6 flex">
            ...
            <div className="hover:bg-gray-500 -mx-6 flex">
                <div className=" flex text-left items-center space-x-4 pl-12 my-2">
                    ...
                    <Link to={'/market'} className="" onClick={() => {setSelected('market')}}>Market</Link>
                </div>
                <div className="flex-grow"></div>
                <div className="flex justify-end">
            ...
            <div className="hover:bg-gray-500 -mx-6 flex">
                <div className=" flex text-left items-center space-x-4 pl-12 my-2">
                    ...
                    <Link to={'/library'} className="" onClick={() => {setSelected('library')}}>Library</Link>
                </div>
                <div className="flex-grow"></div>
                <div className="flex justify-end">
            ...
            <div className="hover:bg-gray-500 -mx-6 flex">
                <div className=" flex text-left items-center space-x-4 pl-12 my-2">
                    ...
                    <Link to={'/portfolio'} className="" onClick={() => {setSelected('portfolio')}}>Portfolio</Link>
                </div>
                <div className="flex-grow"></div>
                <div className="flex justify-end">
            ...
            <div className="hover:bg-gray-500 -mx-6 flex">
                <div className=" flex text-left items-center space-x-4 pl-12 my-2">
                    ...
                    <Link to={'/dashboard'} className="" onClick={() => {setSelected('dashboard')}}>Dashboard</Link>
                </div>
                <div className="flex-grow"></div>
                <div className="flex justify-end">
